...
public class FDocument {
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.path == rhs.path)||((this.path!= null)&&this.path.equals(rhs.path)))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.published == rhs.published)||((this.published!= null)&&this.published.equals(rhs.published))));
    }
