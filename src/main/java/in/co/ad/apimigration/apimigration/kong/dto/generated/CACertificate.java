...
public class CACertificate {
    ...
    public String toString() {
        ...
        sb.append(CACertificate.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("cert");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CACertificate) == false) {
            return false;
        }
        CACertificate rhs = ((CACertificate) other);
