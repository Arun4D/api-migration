...
public class FUpstream {
    ...
    private List<FTarget> targets = new ArrayList<FTarget>();
    ...
    public String toString() {
        ...
        sb.append(FUpstream.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("algorithm");
        sb.append('=');
