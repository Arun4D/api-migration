...
public class FServiceVersion {
    ...
    public String toString() {
        ...
        sb.append(FServiceVersion.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("document");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id)))&&((this.version == rhs.version)||((this.version!= null)&&this.version.equals(rhs.version))))&&((this.document == rhs.document)||((this.document!= null)&&this.document.equals(rhs.document))))&&((this.implementation == rhs.implementation)||((this.implementation!= null)&&this.implementation.equals(rhs.implementation))));
    }
